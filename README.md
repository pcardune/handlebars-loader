...
The following query (or config) options are supported:
 ...
 - *precompileOptions*: Options passed to handlebars precompile. See the Handlebars.js [documentation](https://handlebarsjs.com/api-reference/compilation.html#handlebars-compile-template-options) for more information.
