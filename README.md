...
The following query options are supported:
 ...
 - *knownHelpersOnly*: When set to false, it overrides the default compile-time lookup scan so that you can define helpers during runtime.  Use this option with caution as it skips various compile-time checks.
